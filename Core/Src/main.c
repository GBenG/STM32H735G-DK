...
const osTimerAttr_t myTimerLed_attributes = {
  .name = "myTimerLed"
};
/* Definitions for myLedBinarySem */
...
/* Configure the peripherals common clocks */
  ...
  /* Create the timer(s) */
  /* creation of myTimerLed */
  myTimerLedHandle = osTimerNew(CallbackTimerLed, osTimerPeriodic, NULL, &myTimerLed_attributes);
...
/* USER CODE BEGIN Header_Startl_ledTask */
/**
* @brief Function implementing the ledTask thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_Startl_ledTask */
void Startl_ledTask(void *argument)
{
  /* USER CODE BEGIN Startl_ledTask */
  /* Infinite loop */
  for(;;)
  {
...
void CallbackTimerLed(void *argument)
{
  /* USER CODE BEGIN CallbackTimerLed */

  /* USER CODE END CallbackTimerLed */
}
